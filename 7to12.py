...
if __name__=="__main__":
	...
	dfDec = spark.read.format('com.databricks.spark.csv').options(header='true').load("/Users/Downloads/dataset/6-12/*.csv")
	# dfDec2 = spark.read.format('com.databricks.spark.csv').options(header='true').load("/Users/Downloads/dataset/6-12/*.csv")
	dfDec3 = spark.read.format('com.databricks.spark.csv').options(header='true').load("/Users/Downloads/taxi+_zone_lookup.csv")

...
if __name__=="__main__":
	...
	dfDec = spark.read.format('com.databricks.spark.csv').options(header='true').load("/Users/Downloads/dataset/1-6/*.csv")
	# dfDec2 = spark.read.format('com.databricks.spark.csv').options(header='true').load("/Users/Downloads/dataset/6-12/*.csv")
	...
	# dfDec.write.csv("/Users/Downloads/dataset/result.csv")
	# dfDec.show()
	...
	result_0_4.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/Fri_0_4")
	result_4_8.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/Fri_4_8")
	result_8_12.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/Fri_8_12")
	result_12_16.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/Fri_12_16")
	result_16_20.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/Fri_16_20")
	result_20_24.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/Fri_20_24")
	...
	# tofloat_mon.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/2016-mon")
	# tofloat_tue.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/2016-tue")
	# tofloat_wen.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/2016-wen")
	# tofloat_Tru.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/2016-tru")
	# tofloat_fri.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/2016-fri")
	# tofloat_sat.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/2016-sat")
	# tofloat_sun.write.format("com.databricks.spark.csv").options(header='true').save("/Users/Downloads/2016-sun")
